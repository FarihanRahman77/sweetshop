            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-3" id="accounts_div">
                            ...
                            <select type="text" class="form-control" name="account_status" id="account_status" onchange="getAmount()">
                                <option value="0" selected disabled>Select Accounts</option>
                            </select>
                        ...
                        <table class="table table-bordered table-hover dataTable no-footer m-1" id="manageJournalTable" width="100%">
                            <thead>
                                <tr class="bg-light">
                                    ...
                                    <td width="30%" class="text-center">Total</td>
                                    <td width="30%" class="text-center">Due</td>
