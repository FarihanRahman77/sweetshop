    ...
    foreach ($groupedOrders as $order) {
        ...
        $output['data'][] = array(
         ...
         '<b>Party: </b>' . $order['party_name'] . '<br><b>Contact: </b>' . $order['party_contact'] . '<br><b>Address: </b>' . $order['party_address'],
            '<b>Total: </b>'. $order['order_total']. '<br><b>Discount: </b>' . $order['grand_discount']. '<br><b>Vat: </b>' . $order['vat']. '<br><b>Ait: </b>' . $order['ait']. '<br><b>Grand Total: </b>' . $order['total_amount']. '<br><b>Paid Amount: </b>' . $order['paid_amount'] ,
